...
export default function ClientsMarquee() {
  ...
  const Logo = ({ c }) => (
    <div className="flex h-16 w-40 shrink-0 items-center justify-center rounded-2xl border border-white/10 bg-white/[0.03] px-6 transition hover:border-gold-400/40 hover:bg-white/[0.06]">
      <img
        src={c.logo}
        alt={c.name}
        loading="lazy"
  ...
  return (
    <section className="overflow-hidden border-y border-white/10 bg-white/[0.015] py-16">
      ...
      <div className="relative space-y-4">
        <div className="pointer-events-none absolute inset-y-0 left-0 z-10 w-32 bg-gradient-to-r from-[#121212] to-transparent" />
        <div className="pointer-events-none absolute inset-y-0 right-0 z-10 w-32 bg-gradient-to-l from-[#121212] to-transparent" />
