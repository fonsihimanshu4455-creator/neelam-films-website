    ...
    <>
      ...
      <section className="px-5 py-24 md:px-8 md:py-32">
        <div className="mx-auto grid max-w-7xl items-center gap-14 lg:grid-cols-2">
          <Reveal variant="right" className="relative">
            ...
            />
            <div className="absolute -bottom-6 -right-4 rounded-2xl border border-primary-500/30 bg-ink-900/90 px-7 py-5 backdrop-blur md:-right-6">
      ...
      <section className="border-y border-white/10 bg-ink-900/40 px-5 py-24 md:px-8 md:py-32">
        <div className="mx-auto max-w-5xl">
          ...
          <div className="relative">
            <div className="absolute left-4 top-0 h-full w-px bg-gradient-to-b from-primary-500/60 via-white/10 to-transparent md:left-1/2 md:-translate-x-1/2" />
              ...
              {timeline.map((t, i) => (
                ...
                >
                  ...
                  <div className={`ml-10 md:ml-0 md:w-1/2 ${i % 2 === 0 ? 'md:pr-12 md:text-right' : 'md:pl-12'}`}>
                    <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-5 transition hover:border-primary-500/40">
        ...
        <div className="mx-auto grid max-w-6xl gap-6 md:grid-cols-2">
          {[
            ...
            <motion.div
              ...
              className="relative overflow-hidden rounded-3xl border border-white/10 bg-white/[0.03] p-9"
            >
              <span className="flex h-14 w-14 items-center justify-center rounded-2xl bg-primary-500/15 text-primary-400">
                <b.icon size={28} />
              </span>
              <h3 className="mt-5 font-display text-2xl font-bold text-white">{b.title}</h3>
              <p className="mt-3 leading-relaxed text-slate-400">{b.text}</p>
            </motion.div>
          ))}
        </div>
      </section>
      ...
      <section className="border-t border-white/10 bg-ink-900/40 px-5 py-24 md:px-8 md:py-32">
        <div className="mx-auto max-w-5xl">
          ...
          <Reveal>
            <div className="grid items-center gap-8 rounded-3xl border border-white/10 bg-white/[0.03] p-8 md:grid-cols-[auto,1fr] md:p-12">
              <img
                src={founder.avatar}
                alt={founder.name}
                loading="lazy"
                className="mx-auto h-44 w-44 rounded-3xl border-2 border-primary-500/50 object-cover"
              />
              <div>
                <Quote className="mb-3 text-primary-400" size={32} />
                <p className="font-serif text-2xl italic text-white">“{founder.quote}”</p>
